...
public class MainActivity extends AppCompatActivity
{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.donate:
                Intent donateIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/WhiteRaven777/LauncherReplacer/blob/master/README.md#donations"));
    ...
    {
        Intent helpIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/WhiteRaven777/LauncherReplacer/blob/master/HELP.md"));
    ...
    private void UpdateList()
    {
        ...
        SharedPreferences settings = getSharedPreferences("LauncherReplacer", MODE_PRIVATE);
    ...
    private void showSecurityAlert() {
        ...
        String adbCommand4 = "# pm grant com.whiteraven777.launcherreplacer android.permission.SYSTEM_ALERT";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (!isAccessibilityEnabled(context, "com.whiteraven777.launcherreplacer/.AccServ"))
        {
            AlertDialog.Builder builder = new AlertDialog.Builder(this)
                    .setTitle("Accessibility Service Disabled")
                    .setMessage("Accessible Service is disabled. You must enable it to ensure Launcher Replacer's functionality")
                    .setCancelable(true)
        ...
        else if (getApplicationContext().getSharedPreferences("LauncherReplacer", MODE_PRIVATE).getString("ChosenLauncher", "com.whiteraven777.launcherreplacer").equals("com.whiteraven777.launcherreplacer"))
            Toast.makeText(getApplicationContext(),"Please select a launcher", Toast.LENGTH_LONG).show();


        setContentView(com.whiteraven777.launcherreplacer.R.layout.activity_main);
